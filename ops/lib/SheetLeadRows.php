...
final class SheetLeadRows
{
    ...
    public const HEADERS = [
        'Дата создания', 'Время создания', 'Телефон', 'Имя', 'Email', 'Заметка TrexGo',
        'Статус', 'Комментарий клиента', 'utm_source', 'utm_medium', 'utm_campaign',
        'utm_content', 'utm_term', 'yclid', 'id', 'Компания', 'Источник', 'Страница',
    ...
    public static function legendRows(): array
    {
        $columns = [
            ...
            ['Заметка TrexGo', 'вручную', 'Рабочие заметки по заявке.'],
